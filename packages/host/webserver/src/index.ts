...
export interface Config {
  /** Listen host; the supported values are loopback, all-interfaces IPv4, and dual-stack all-interfaces IPv6. */
...
export class WebServer extends Service {
  static Config: z<Config> = z.object({
    host: z.union([z.const('127.0.0.1'), z.const('0.0.0.0'), z.const('::')]).required(),
